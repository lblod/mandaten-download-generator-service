 ...
 */
export async function insertNewExportFile(file, format) {
  const exportId = uuid();
  ...
  await updateSudo(logicalFileQuery, {}, env.sparqlConnectionOptions);
  ...
  await updateSudo(phyFileQuery, {}, env.sparqlConnectionOptions);
